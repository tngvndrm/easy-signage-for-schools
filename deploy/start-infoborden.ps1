...
# ("At startup") to keep it running — see docs/install.md, Part 1.4.
...
if (-not (Test-Path ".env.local")) {
  Write-Error ".env.local not found next to package.json - create it first (docs/install.md, Part 1.3)."
}
